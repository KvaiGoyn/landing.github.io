...
export const metadata: Metadata = {
  ...
  description: "Производство металлоизделий под ключ в Екатеринбурге: сварка, порошковая покраска, решётки, ворота, навесы. Гарантия до года.", // 130 символов
  ...
  openGraph: {
    ...
    description: "Производство металлоизделий под ключ в Екатеринбурге: сварка, порошковая покраска, решётки, ворота, навесы. Гарантия до года.",
    type: "website",
    ...
    <html lang="ru" className="h-full antialiased">
              ...
              "@graph": [
                {
                  ...
                  "name": "Стиль Мастер",
                  "description": "Профессиональное производство металлоизделий под ключ: сварочные работы, порошковая покраска, антивандальные решётки, ворота, навесы.",
                  "url": "https://stylmaster.ru",
                ...
                },
                {
                  ...
                  "description": "Изготовление металлоконструкций, каркасов, ворот, заборов, навесов, лестниц. Работаем с чёрным металлом, нержавеющей сталью и алюминием.",
                  "provider": {
                    "@id": "https://stylmaster.ru/#organization"
                  },
                  "offers": {
      ...
      <body className={`${inter.className} min-h-screen flex flex-col bg-background text-foreground`}>
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/110576597"
